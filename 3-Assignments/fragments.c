/* 
Title       : 32_fragments.c 
Author      : Sandeep
Date        : 10 July 2019
Description : Read arrays with different number of elements. Find the average of elements and store the average in the last block of array. Print the arrays according to averages in ascending order.
Input       : Number of arrays, Elements in each array
output      : Print arrays according to ascending order of average of each array
 */
